...
def read_labels(participant: str):
    sensor_data = pd.read_csv('/Users/alexander/Documents/Ressources/decompressed/' + participant + '.csv')
    ...
    sensor_data['fine'] = np.full(fill_value='not_labeled', shape=sensor_data.shape[0])
    sensor_data['ball'] = np.full(fill_value='not_labeled', shape=sensor_data.shape[0])
    ...
    labels = pd.read_csv('/Users/alexander/Documents/Ressources/eaf_projects/' + participant + '.txt', delimiter='\t',
...
for participant in labeled_participants:
    ...
    data.to_csv('/Users/alexander/Documents/Ressources/ready/' + participant + '.csv', sep=',')
